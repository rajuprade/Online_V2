...
void load_data(char fname[200],setdata *set)
{
  ...
  FILE *fp2 = fopen("/home/teleset/Online_v2/Ant_sel/Results", "w"); //opens up a file called "Results"
                                                           // and allows writing//
   ...
   while( ( ch = fgetc(fp) ) != EOF )
    {
     if(ch =='#')
      ...
      fclose(fp2);
      FILE *f3 = fopen("/home/teleset/Online_v2/Ant_sel/Results", "r");    
...
void file_input(setdata *set)
{
      ...
      /*  printf("please input the file name: ");
        ...
        sprintf(path, "/home/teleset/Online_v2/proto_online"); //Change pathway as needed //
