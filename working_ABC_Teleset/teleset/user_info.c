...
void load_data(char fname[200],setdata *set)
{
  ...
  FILE *fp2 = fopen("/home/teleset/Results", "w"); //opens up a file called "Results"
                                                           // and allows writing//
   ...
   while( ( ch = fgetc(fp) ) != EOF )
    {
     if(ch =='#')
      ...
      fclose(fp2);
      FILE *f3 = fopen("/home/teleset/Results", "r");    
...
void file_input(setdata *set)
{
       char path[200], basename[200], input_fname[200]; 
        ...
        sprintf(path, "/home/teleset/Online_v2/working_ABC_Teleset/teleset"); //Change pathway as needed //
